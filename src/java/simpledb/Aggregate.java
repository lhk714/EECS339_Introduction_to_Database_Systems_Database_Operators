...
public class Aggregate extends Operator {
	...
	// some code goes here
    	...
    	if(aggregatortype==Type.INT_TYPE){
    		aggregator = new IntegerAggregator(gfield, groupbytype, afield, aop);
    	}
    	else if(aggregatortype==Type.STRING_TYPE){
    		aggregator = new StringAggregator(gfield, groupbytype, afield, aop);
    	}
	...
	// some code goes here
	//return null;
    	return new DbIterator[] {aiterator};
    }
