...
public class HeapPage implements Page {
    ...
    */
    ...
    public void deleteTuple(Tuple t) throws DbException {
    	...
    	if(rid==null||this.pid.equals(rid.getPageId())==false){
    		throw new DbException("No tuple found.");
    	}
    	if(isSlotUsed(rid.tupleno())==false){
    ...
    public void insertTuple(Tuple t) throws DbException {
    	...
    	if(emptyslot==false||slotnum==-1){
    		throw new DbException("Page is full.");
    	}
    	t.setRecordId(new RecordId(this.pid,slotnum));
    	this.tuples[slotnum] = t;
    	markSlotUsed(slotnum, true);
    ...
    private void markSlotUsed(int i, boolean value) {
    	...
    	int bytenum = i/8;
    	int bitnum = i%8;
    	if(isSlotUsed(i)^value){//^ is exclusiveOR
